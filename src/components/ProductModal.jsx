      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md md:max-w-4xl max-h-[80vh] overflow-y-auto animate-modal">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 p-4 md:p-8">
            ...
            <p className="text-gray-600 mb-4 sm:mb-6">{product.description}</p>
            ...
            <div className="text-3xl sm:text-4xl font-bold text-blue-600 mb-6 sm:mb-8">
              {product.price}
            </div>
            ...
            <a
              ...
              className="block w-full bg-gradient-to-r from-green-500 to-green-600 text-white py-3 sm:py-4 px-6 rounded-xl text-center font-bold text-lg hover:shadow-lg hover:scale-105 transition-all duration-300 flex items-center justify-center"
            >
              <FaWhatsapp className="mr-2 sm:mr-3" size={24} />
              Chat Vendor on WhatsApp
            </a>

            <div className="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex items-center text-gray-700">
                <FaTruck className="mr-2 sm:mr-3 text-blue-500" />
                <div>
              ...
              <div className="flex items-center text-gray-700">
                <FaShoppingBag className="mr-2 sm:mr-3 text-purple-500" />
                <div>
