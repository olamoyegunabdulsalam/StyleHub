...
export const Hero = ({ onWhatsAppClick }) => (
  <div className="relative bg-gradient-to-br from-purple-900 via-purple-700 to-pink-600 text-white overflow-hidden">
    <div className="absolute inset-0 bg-black opacity-20"></div>
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
      <div className="text-center">
        <h1 className="text-4xl md:text-6xl font-bold mb-6 animate-fade-in">
          Trendy & Affordable Fashion Delivered Fast
        </h1>
        <p className="text-xl md:text-2xl mb-8 text-purple-100">
          Browse. Select. Chat Us. Get It Delivered.
        </p>
        <button
